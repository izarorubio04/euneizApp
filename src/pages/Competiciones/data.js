export const competiciones = [
  {
    ...
    fecha: "Mayo 15",
    descripcion: "Fase de grupos + fase final. Equipos formados por estudiantes de distintos grados.",
    tipo: "futsal", // Añado esto para controlar columnas de tabla
    grupos: [
      {
        nombre: "Grupo A",
        tabla: [
...

  {
    id: "esports",
    tipo: "lol",
    titulo: "Esports EUNEIZ LoL",
    fecha: "Mayo",
    descripcion: "Fase de grupos + playoffs. Equipos de LoL.",
    grupos: [
      {
        nombre: "Grupo A",
        tabla: [
